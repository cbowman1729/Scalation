      ...
      extends Queue [SimActor] with Component
{
    ...
    override def toString = "WaitQueue(" + name + ")"
...
object WaitQueue
{
   ...
   //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    def group (xy: Tuple2 [Int, Int], size: Tuple2 [Int, Int], 
               que: Tuple2 [String, Tuple2 [Int, Int]]*): List [WaitQueue] =
    {
        val queueGroup = new ListBuffer [WaitQueue] ()
        for (q <- que) queueGroup += new WaitQueue (q._1, Array (xy._1 + q._2._1, xy._2 + q._2._2, size._1, size._2))
        queueGroup.toList
    } // group
