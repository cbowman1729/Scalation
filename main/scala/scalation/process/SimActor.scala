...
//       extends Actor with Ordered [SimActor] with Monitor with Identifiable with PQItem
         extends Coroutine (name) with PQItem with Ordered [SimActor] with Locatable
{
    setName (name)

    /** The time at which the entity/sim-actor arrived
     */
    private var _arrivalT = director.clock
    ...
    /** The indicator of subtype of the sim-actor
     */
    private var _mySource: Source = null 
     ...
     */
    def arrivalT: Double = _arrivalT

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Set this actor's arrival/(re)-creation time.
     */
    def setArrivalT (aTime: Double) { _arrivalT = aTime }
     ...
     */
    def mySource: Source = _mySource

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Set the sim-actor's source.
     *  @param subtype  the sim-actors subtype
     */
    def setMySource (mySource: Source) { _mySource = mySource }
